...
/* question 9 Favorite Number:
 ...
 Print that message.*/
var fav_num = 92;
var msg = "My favourite number is 92";
...
var names = ["usman", "hussain", "raza", "ali"];
console.log(names[0]);
console.log(names[1]);
console.log(names[2]);
console.log(names[3]);
...
var friendsName = ["Hamza", "saba", "umer", "noor"];
...
var transportation = ["Honda bike", "civic car", "cycle"];
...
var guests = ["nimra", "noor", "sana", "sadia"];
...
var country = ["Pakistan", "U.A.E", "Turkey"];
...
var person = { name: "Noman", fname: "Saleem", age: 26 };
console.log(person);
...
var name_1 = "Noman";
var name_2 = "Noman Ghazaini";
var name_3 = "Sir Noman Ghaziani";
// if (name_1 == name_3)[
